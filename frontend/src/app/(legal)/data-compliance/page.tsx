    ...
    <article>
      ...
      <Section title="2. Data Security Measures">
        ...
        <SubSection title="2.4 Infrastructure">
          <p>BuildLedger is hosted on dedicated VPS infrastructure. File uploads are stored on isolated storage with access-controlled signed URLs. Database and uploaded-file backups are performed regularly, encrypted before storage, and retained on a rolling schedule.</p>
        </SubSection>
        <SubSection title="2.5 Backup Policy">
          <ul>
            <li>Database snapshots are created daily during off-peak hours.</li>
            <li>Uploaded files and company logos are included in the same encrypted backup archive.</li>
